...
$pino_passo = $gpio->getOutputPin(5);
$pino_direcao = $gpio->getOutputPin(4);
...
$interruptWatcher->register($buttonPin, function () use ($ledPin) {
    ...
    digitalWrite($pino_direcao, $direcao);
     ...
     {
      $pino_passo->setValue(OutputPinInterface::VALUE_HIGH);
      usleep(100000);
      $pino_passo->setValue(OutputPinInterface::VALUE_LOW);
      usleep(100000);
     }
